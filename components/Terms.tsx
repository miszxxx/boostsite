    ...
    <div className="max-w-5xl mx-auto px-6 pb-24 relative overflow-hidden">
      ...
      <div className="py-20 space-y-8 relative">
        <div className="space-y-3">
          <div className="text-sm font-semibold tracking-[0.2em] text-[#f4adfb] uppercase">
            Terms of Service
          </div>
          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight bg-gradient-to-r from-[#f4adfb] via-[#5b2873] to-[#f4adfb] bg-clip-text text-transparent">
            Terms & Conditions
          </h1>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="h-[1px] flex-1 bg-gradient-to-r from-[#f4adfb]/20 via-[#5b2873]/20 to-transparent" />
          <span className="text-sm font-medium text-muted-foreground/90 whitespace-nowrap">
            Last Updated: April 5, 2024
          </span>
          <div className="h-[1px] w-12 bg-[#f4adfb]/20" />
        </div>
      </div>
